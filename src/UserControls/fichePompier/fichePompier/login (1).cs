...
namespace fichePompier
{
    public partial class login : Form
    {
        ...
        private void btn_valider_Click(object sender, EventArgs e)
        {
            ...
            string sql = "select id from Admin where login = @log and mdp = @motDePasse";
            SQLiteCommand cmd = new SQLiteCommand(sql, cx);
            cmd.Parameters.AddWithValue("@log", txt_username.Text.Trim());
            cmd.Parameters.AddWithValue("@motDePasse", txt_mdp.Text.Trim());
